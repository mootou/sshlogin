...
void usage()
{
	printf("\n"
			...
			"choose a record:     sshlogin -c vnet\n"
			"add a record:        sshlogin -a vjc 119.188.68.21 phy\n"
			"add a lot records:   sshlogin -A vjc 119.188.68 21 23 phy\n"
			"scp file to a ip:    sshlogin -t 119.188.68.21 /local/file\n"
			"scp file to own:     sshlogin -r 119.188.68.21 /remote/file /local/\n"
			"scp file to a group: sshlogin -T (vjc|all) /local/file\n"
			"ssh a cmd in remote: sshlogin -x 119.188.68.21 \"ls /data1\"\n"
			"ssh a cmd in remote: sshlogin -X (vjc|all) \"ls /data1\"\n"
			"\n"
